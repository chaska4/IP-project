...
const dbCon = mysql.createConnection({
    ...
    user: "C4131SN22U81",               // replace with the database user provided to you
    password: "6611",           // replace with the database password provided to you
    database: "C4131SN22U81",           // replace with the database user provided to you
    port: 3306
});
...
dbCon.connect(function (err) {
    ...
    const saltRounds = 10;
    const myPlaintextPassword = '7zur6rbb';// replace with acc_password chosen by you OR retain the same value
